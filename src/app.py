...
activities = {
    ...
    "Soccer Club": {
        "description": "Skill-building drills and friendly soccer games",
    ...
    "Drama Club": {
        "description": "Acting, improv, and stage performance practice",
        "schedule": "Wednesdays, 3:30 PM - 5:00 PM",
        "max_participants": 20,
        "participants": ["charlotte@mergington.edu", "harper@mergington.edu"]
    },
    "Debate Society": {
        "description": "Develop argumentation, public speaking, and critical thinking skills",
